...
public class RobotLearning1 {
    ...
    public double getExpected(Arm a){
        return a.expected();
    }
    ...
    public double Q(Arm a){
        ...
        a.sumReward += reward;
        a.count++;
        a.q = a.q + (1.0/a.count)*(reward - a.q);
        return a.q;
    }
    ...
    public static void main(String[] args){
        ...
        double expVal = 0.0;
        expVal = rl.getExpected(rl.a[0]) + rl.getExpected(rl.a[1]) +
                    rl.getExpected(rl.a[2]) + rl.getExpected(rl.a[3]);
